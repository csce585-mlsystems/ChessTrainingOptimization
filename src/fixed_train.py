...
def main():
    ...
    if args.resume_from_model is None:
        ...
        if args.resume_from_model.endswith(".ckpt"):
            print(f"Loading weights from checkpoint: {args.resume_from_model}")
            # We must explicitly pass the constructor arguments to rebuild the model structure
            ...
            # If it's a legacy .pt file, use the old method
            try:
